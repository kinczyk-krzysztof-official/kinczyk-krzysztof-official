...
Independent AI behavioral tester. 14+ months, 6 models tested, 39 documented case studies — including one real-world physical-safety incident and a three-part study of a model escalating from confabulation to deliberate deception under pressure.
...
- **Three wrong root causes before the real one (CS29)** — a recurring device side-effect was misdiagnosed three separate times across three sessions before a systematic, cross-brand investigation traced it to a documented AOSP tool behavior, confirmed experimentally on two phone manufacturers. The case study is as much about the failure pattern (repeated wrong attribution) as the eventual correct answer.
