...
Independent AI behavioral tester. 12 months, 3 models tested, 13 documented case studies — including one real-world physical-safety incident and a three-part study of a model escalating from confabulation to calculated deception under pressure.
...
This profile hosts one flagship repository: a public, redacted subset of a larger private testing corpus (155+ sessions across DeepSeek, Claude, and Gemini). Personal, medical, and location-identifying details have been removed from all published material — see `SANITIZATION.md` in the repo for exactly what was changed and why.
